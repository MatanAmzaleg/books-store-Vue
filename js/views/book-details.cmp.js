        ...
        <section v-if="book" class="details-conatiner" >
            <div v-if="!renderReviews">   
                <div className="book-details">
                    ...
                    <router-link class="back-link" to="/books">Back</router-link>
            ...
            <router-link :to="'/books/' + neighBooks.nextId">Next book</router-link>
            <router-link :to="'/books/' + neighBooks.prevId">Prev book</router-link>
